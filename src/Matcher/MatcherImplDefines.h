...
#define RSID_STRONG_THRESHOLD_PNM_GNM                (1228)
#define RSID_STRONG_THRESHOLD_PNM_GNM_RGB_IMG_ENROLL (600) // for enroll from image W10 vs. RGB features.
#define RSID_STRONG_THRESHOLD_PM_GM                  (1318)
#define RSID_STRONG_THRESHOLD_PM_GNM                 (965)

#define RSID_UPDATE_THRESHOLD_PNM_GNM      (1745)
#define RSID_UPDATE_THRESHOLD_PM_GM        (1745)
#define RSID_UPDATE_THRESHOLD_PM_GNM_FIRST (1450)
...
#define RSID_LIN1_SCORE_1      RSID_STRONG_THRESHOLD_PNM_GNM
#define RSID_LIN1_SCORE_2      RSID_IDENTICAL_THRESHOLD_GNM_GNM
#define RSID_LIN1_CONFIDENCE_1 95
#define RSID_LIN1_CONFIDENCE_2 99
#define RSID_LIN1_CURVE_HR     11

#define RSID_LIN1_CURVE_MULTIPLIER                                                                                     \
    (static_cast<int>((((RSID_LIN1_CONFIDENCE_2 - RSID_LIN1_CONFIDENCE_1) << RSID_LIN1_CURVE_HR) /                     \
                       (RSID_LIN1_SCORE_2 - RSID_LIN1_SCORE_1))))
...
#define RSID_LIN2_SCORE_2      RSID_STRONG_THRESHOLD_PNM_GNM
#define RSID_LIN2_CONFIDENCE_1 (60)
#define RSID_LIN2_CONFIDENCE_2 (95)
#define RSID_LIN2_CURVE_HR     (11)
#define RSID_LIN2_CURVE_MULTIPLIER                                                                                     \
    (static_cast<int>((((RSID_LIN2_CONFIDENCE_2 - RSID_LIN2_CONFIDENCE_1) << RSID_LIN2_CURVE_HR) /                     \
                       (RSID_LIN2_SCORE_2 - RSID_LIN2_SCORE_1))))
